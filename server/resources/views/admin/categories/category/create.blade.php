          ...
          <div class="card-body">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <div class="input-group input-group-merge">
                      ...
                      <input class="form-control @error('schedule') is-invalid @enderror" placeholder="Schedule (ex. Sunday Night)" type="text" name="schedule" value="{{ old('schedule')}}" id="schedule">
                      @error('schedule')
                          <div class="invalid-feedback">
                              {{ $message }}
                          </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <div class="input-group input-group-merge">
                      ...
                      <input class="form-control @error('instagram') is-invalid @enderror" placeholder="Your instagram (Ex. username)" type="text" name="instagram" value="{{ old('instagram') }}" id="instagram">
                      @error('instagram')
                          <div class="invalid-feedback">
                              {{ $message }}
                          </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <div class="input-group input-group-merge">
                      ...
                      <input class="form-control @error('whatsapp') is-invalid @enderror" placeholder="Your Whatsapp (Ex. 6285704152724)" type="text" name="whatsapp" value="{{ old('whatsapp')}}" id="whatsapp">
                      @error('whatsapp')
                          <div class="invalid-feedback">
                              {{ $message }}
                          </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <div class="input-group input-group-merge">
                      <textarea class="form-control @error('description') is-invalid @enderror" rows="3" placeholder="Description" name="description" id="description"></textarea>
                      @error('description')
                          <div class="invalid-feedback">
                              {{ $message }}
                          </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <div class="input-group input-group-merge">
                      ...
                      <input class="form-control @error('link_youtube') is-invalid @enderror" placeholder="Your Link Youtube (Ex. 4wQ_gj4huXI)" type="text" name="link_youtube" value="{{ old('link_youtube')}}" id="link_youtube">
                      @error('link_youtube')
                          <div class="invalid-feedback">
                              {{ $message }}
                          </div>
