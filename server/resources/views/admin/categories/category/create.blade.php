                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <div class="input-group input-group-merge">
                      ...
                      <input class="form-control @error('instagram') is-invalid @enderror" placeholder="Your instagram" type="text" name="instagram" value="{{ old('instagram') }}" id="instagram">
                      @error('instagram')
                          <div class="invalid-feedback">
                              {{ $message }}
                          </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <div class="input-group input-group-merge">
                      ...
                      <input class="form-control @error('whatsapp') is-invalid @enderror" placeholder="Your Whatsapp" type="text" name="whatsapp" value="{{ old('whatsapp')}}" id="whatsapp">
                      @error('whatsapp')
                          <div class="invalid-feedback">
                              {{ $message }}
                          </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <div class="input-group input-group-merge">
                      ...
                      <input class="form-control @error('link_youtube') is-invalid @enderror" placeholder="Your Link Youtube" type="text" name="link_youtube" value="{{ old('link_youtube')}}" id="link_youtube">
                      @error('link_youtube')
                          <div class="invalid-feedback">
                              {{ $message }}
                          </div>
